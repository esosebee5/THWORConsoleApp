namespace THWOR.src.titles
{
    class GameStrings
    {
        ...
        //        static final String title = "Game Strings";
        ...
        const string title = "Game Strings";

        private const string BigWordsThe = ""
            + " _______ _   _ _____ \n"
            + "|__   __| | | | ____|\n"
            + "   | |  | |_| | |___ \n"
            + "   | |  |  _  |  ___|\n"
        ...
        private const string BigWordsHouse = "" +
            " _   _  ___  _   _  ____ _____ \n" +
            "| | | |/ _ \\| | | |/ ___|  ___|\n" +
            "| |_| | | | | | | | |__ | |___ \n" +
            "|  _  | | | | | | |\\__ \\|  ___|\n" +
        ...
        private const string BigWordsWith = "" +
            " _      _ _ _____ _   _ \n" +
            "| |    | | |_   _| | | |\n" +
            "| |    | | | | | | |_| |\n" +
            "| | __ | | | | | |  _  |\n" +
        ...
        private const string BigWordsOne = "" +
            "  ___  _   _ _____ \n" +
            " / _ \\| \\ | |  ___|\n" +
            "| | | |  \\| | |___ \n" +
            "| | | |     |  ___|\n" +
        ...
        private const string BigWordsRoom = "" +
            " _____   ___   ___  _     _  \n" +
            "|  __ \\ / _ \\ / _ \\| \\   / | \n" +
            "| |__) | | | | | | |  \\_/  | \n" +
            "|     /| | | | | | | |\\_/| | \n" +
        ...
        private const string Welcome = "\tWelcome To\n The House With One Room";
        private const string Welcome2 = @"       Welcome To
 The House With One Room";
